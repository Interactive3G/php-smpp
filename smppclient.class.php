...
class SmppClient
{
	 ...
	 */
	public function sendSMS($isCaring, $spClass, $spService, SmppAddress $from, SmppAddress $to, $message, $tags=null, $dataCoding=SMPP::DATA_CODING_DEFAULT, $priority=0x00, $scheduleDeliveryTime=null, $validityPeriod=null)
	{
