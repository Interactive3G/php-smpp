...
class SmppClient
{
	 ...
	 */
	public function sendSMS(boolean $isCaring, $spClass, $spService, SmppAddress $from, SmppAddress $to, $message, $tags=null, $dataCoding=SMPP::DATA_CODING_DEFAULT, $priority=0x00, $scheduleDeliveryTime=null, $validityPeriod=null)
	{
	 ...
	 * @return string message id
	 */
	protected function submit_sm($sp_class, $sp_service,SmppAddress $source, SmppAddress $destination, $short_message=null, $tags=null, $dataCoding=SMPP::DATA_CODING_DEFAULT, $priority=0x00, $scheduleDeliveryTime=null, $validityPeriod=null, $esmClass=null)
	{
...
class SMPP
{
	...
	// Vodafone Italy specific commands
	const SUBMIT_SM = 0x00010200;
	const SUBMIT_SM_RESP = 0x80010200;
	const RECHARGE_MT = 0x00010201;
	const RECHARGE_MT_RESP = 0x80010201;
	const ACCOUNT_INFO = 0x00010202;
	const ACCOUNT_INFO_RESP = 0x80010202;
	const SUBMIT_CARING = 0x00010203;
	const SUBMIT_CARING_RESP = 0x80010203;
	...
	// Vodafone Italy extensions

	const ESME_RINVPYRADR = 0x00000400;
	const ESME_RINVPYRTON = 0x00000401;
	const ESME_RINVPYRNPI = 0x00000402;
	const ESME_RINVSPCLASS = 0x00000403;
	const ESME_RINVSPSERV = 0x00000404;
	const ESME_RINVRGSTDLVRD = 0x00000405;
...
class SmppTag
{
	...
	// Vodafone specific extensions
	const VOD_SP_DATE = 0x1400;
	const VOD_NOTIFY_DEBIT = 0x1401;
	const VOD_NOTIFY = 0x1402;
	const VOD_SC_TIMESTAMP = 0x1403;
	const VOD_VS_RETINFO = 0x1404;
	const VOD_CS_CODE = 0x1405;
